...
Extra credit
If you don't like configuration and/or .ini files, could you do this yourself in Python code?

Can we have multiple .ini configuration files for a project? Why might you want to do that?

The entry point in setup.py didn't mention __init__.py when it declared tutorial:main function. Why not?

What is the purpose of **settings? What does the ** signify?

Creating a Pyramid Project, Pyramid cookiecutters, What Is This pserve Thing, Environment Variables and .ini File Settings, PasteDeploy Configuration Files
